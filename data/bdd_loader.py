...
class BDD:
    ...
    def _get_images(self):
        ...
        if self.img_dir is None:
            raise ValueError(
                "Image directory path is not specified in the configuration."
            )
    ...
    def _get_labels(self, istrain=False, yolo=False):
        ...
        for i in tqdm(
            ...
            for __label in __labels:
                ...
                __traffic_light_color = __label.get("attributes").get(
                ...
                class_id, x_center, y_center, width, height = self.__yolo_annot(
                    __class_id, x1, x2, y1, y2, w, h
                )
            ...
            if yolo:
                ...
                yolo_writer(
                    ...
                    os.path.join(
                        yolo_dir,
                        "train" if istrain else "val",
                        __image_name.replace(".jpg", ".txt"),
                    ),
                )
                del yolo_annots
